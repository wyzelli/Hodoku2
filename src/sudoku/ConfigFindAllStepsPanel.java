...
public class ConfigFindAllStepsPanel extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		fishTypeComboBox = new javax.swing.JComboBox<String>();
		fishFromLabel = new javax.swing.JLabel();
		fishFromComboBox = new javax.swing.JComboBox<String>();
		fishToLabel = new javax.swing.JLabel();
		fishToComboBox = new javax.swing.JComboBox<String>();
		fishMaxFinsLabel = new javax.swing.JLabel();
		fishMaxFinsComboBox = new javax.swing.JComboBox<String>();
		fishMaxEndoFinsLabel = new javax.swing.JLabel();
		fishMaxEndoFinsComboBox = new javax.swing.JComboBox<String>();
		...
		krakenFishFromComboBox = new javax.swing.JComboBox<String>();
		krakenFishToLabel = new javax.swing.JLabel();
		krakenFishToComboBox = new javax.swing.JComboBox<String>();
		...
		alsChainLengthComboBox = new javax.swing.JComboBox<String>();
		alsBiDirCheckBox = new javax.swing.JCheckBox();

		resetButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.resetButton.mnemonic").charAt(0));
		...
		fishPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ConfigFindAllStepsPanel.fishPanel.border"))); // NOI18N

		fishCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.fishCheckBox.mnemonic").charAt(0));
		fishCheckBox.setText(bundle.getString("ConfigFindAllStepsPanel.fishCheckBox.text")); // NOI18N

		fishTypeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.fishTypeLabel.mnemonic").charAt(0));
		...
		fishTypeComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		fishFromLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.fishFromLabel.mnemonic").charAt(0));
		...
		fishFromComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		fishToLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.fishToLabel.mnemonic").charAt(0));
		...
		fishToComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		fishMaxFinsLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.fishMaxFinsLabel.mnemonic").charAt(0));
		...
		fishMaxFinsComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		fishMaxEndoFinsLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.fishMaxEndoFinsLabel.mnemonic").charAt(0));
		...
		fishMaxEndoFinsComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		fishCheckTemplatesCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.fishCheckTemplatesCheckBox.mnemonic").charAt(0));
		...
		fishPanelLayout.setHorizontalGroup(fishPanelLayout
				...
				.addGroup(fishPanelLayout.createSequentialGroup().addGroup(fishPanelLayout
						...
						.addGroup(fishPanelLayout.createSequentialGroup().addContainerGap().addGroup(fishPanelLayout
								...
								.addGroup(fishPanelLayout.createSequentialGroup().addComponent(fishCandidatesLabel)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		fishPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { fishMaxEndoFinsComboBox, fishMaxFinsComboBox });

		fishPanelLayout.setVerticalGroup(fishPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(fishPanelLayout.createSequentialGroup().addComponent(fishCheckBox)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(fishPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(fishTypeLabel).addComponent(fishTypeComboBox,
						...
						.addGroup(fishPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								...
								.addComponent(fishToLabel).addComponent(fishToComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(fishPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(fishMaxFinsLabel).addComponent(fishMaxFinsComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(fishPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(fishMaxEndoFinsLabel).addComponent(fishMaxEndoFinsComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(fishCheckTemplatesCheckBox)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(fishPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(fishCandidatesLabel).addComponent(fishCandidatesResultLabel)
								.addComponent(fishCandidatesButton))));

		krakenFishPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ConfigFindAllStepsPanel.krakenFishPanel.border"))); // NOI18N

		krakenFishMaxEndoFinsComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		krakenFishMaxEndoFinsLabel
				.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
						.getString("ConfigFindAllStepsPanel.krakenFishMaxEndoFinsLabel.mnemonic").charAt(0));
		...
		krakenFishMaxFinsLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.krakenFishMaxFinsLabel.mnemonic").charAt(0));
		...
		krakenFishFromLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.krakenFishFromLabel.mnemonic").charAt(0));
		...
		krakenFishFromComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		...
		krakenFishToComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		krakenFishTypeComboBox.setModel(
				new javax.swing.DefaultComboBoxModel<String>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

		krakenFishTypeLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.krakenFishTypeLabel.mnemonic").charAt(0));
		...
		krakenFishCandidatesResultLabel
				.setText(bundle.getString("ConfigFindAllStepsPanel.krakenFishCandidatesResultLabel.text")); // NOI18N
		...
		krakenFishPanelLayout.setHorizontalGroup(krakenFishPanelLayout
				...
				.addGroup(krakenFishPanelLayout.createSequentialGroup().addContainerGap().addGroup(krakenFishPanelLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(krakenFishPanelLayout
								.createSequentialGroup().addGroup(krakenFishPanelLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		...
		krakenFishPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { krakenFishMaxEndoFinsComboBox, krakenFishMaxFinsComboBox });

		krakenFishPanelLayout
				.setVerticalGroup(krakenFishPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(krakenFishPanelLayout.createSequentialGroup().addGroup(krakenFishPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(krakenFishTypeLabel).addComponent(
										krakenFishTypeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(krakenFishPanelLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(krakenFishFromLabel)
										.addComponent(krakenFishFromComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(krakenFishToLabel).addComponent(krakenFishToComboBox,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								...
								.addGroup(krakenFishPanelLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(krakenFishMaxEndoFinsLabel).addComponent(
												krakenFishMaxEndoFinsComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(krakenFishPanelLayout
		...
		alsPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(bundle.getString("ConfigFindAllStepsPanel.alsPanel.border.title"))); // NOI18N

		alsChainLengthLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.alsChainLengthLabel.mnemonic").charAt(0));
		...
		alsChainLengthComboBox
				.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "4", "5", "6", "7" }));

		alsBiDirCheckBox.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigFindAllStepsPanel")
				.getString("ConfigFindAllStepsPanel.alsBiDirCheckBox.mnemonic").charAt(0));
		...
		for (int i = 0; i < steps.length; i++) {
			...
			if (act == null) {
				...
				act = new CheckNode(steps[i].getCategoryName(), true,
						steps[i].isAllStepsEnabled() ? CheckNode.FULL : CheckNode.NONE, null, true, false, false,
						steps[i].getCategory());
				root.add(act);
			}
	...
	private javax.swing.JComboBox<String> alsChainLengthComboBox;
	...
	private javax.swing.JComboBox<String> fishFromComboBox;
	private javax.swing.JLabel fishFromLabel;
	private javax.swing.JComboBox<String> fishMaxEndoFinsComboBox;
	private javax.swing.JLabel fishMaxEndoFinsLabel;
	private javax.swing.JComboBox<String> fishMaxFinsComboBox;
	private javax.swing.JLabel fishMaxFinsLabel;
	private javax.swing.JPanel fishPanel;
	private javax.swing.JComboBox<String> fishToComboBox;
	private javax.swing.JLabel fishToLabel;
	private javax.swing.JComboBox<String> fishTypeComboBox;
	...
	private javax.swing.JComboBox<String> krakenFishFromComboBox;
	...
	private javax.swing.JComboBox<String> krakenFishToComboBox;
