...
public class ConfigTrainigPanel extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		resetButton.setMnemonic(java.util.ResourceBundle.getBundle("intl/ConfigTrainingPanel")
				.getString("ConfigTrainingPanel.resetButton.mnemonic").charAt(0));
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(chosenLabel)
